...
KB_FIGURE_PATH_SCATTER <- "plots/scatter/"

KB_LBL_JS_CODE<- "JavaScript code"
KB_LBL_OPT_LVL <- "Optimization level"
KB_LBL_TREATMENT <- "Treatment"
KB_LBL_SUBJECT_ID <- "Subject ID"
...
KB_TITLE_PLOT_TIME_TREATMENT <- paste(KB_LBL_TIME, "x", KB_LBL_TREATMENT)
KB_TITLE_PLOT_ENERGY_TREATMENT <- paste(KB_LBL_ENERGY, "x", KB_LBL_TREATMENT)
KB_TITLE_PLOT_TIME_SUBJECT <- paste(KB_LBL_TIME, "x", KB_LBL_SUBJECT_ID)
KB_TITLE_PLOT_ENERGY_SUBJECT <- paste(KB_LBL_ENERGY, "x", KB_LBL_SUBJECT_ID)
KB_TITLE_PLOT_TIME_ENERGY <- paste(KB_LBL_ENERGY, "x", KB_LBL_TIME)
